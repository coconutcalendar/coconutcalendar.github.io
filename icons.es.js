...
var AISearch = createSvgIcon(React.createElement(React.Fragment, null,
...
var ArrowBackIos = createSvgIcon(React.createElement("path", { d: "M640-80 240-480l400-400 71 71-329 329 329 329-71 71Z" }), 'ArrowBackIos', '0 -960 960 960');
...
var ArrowForwardIos = createSvgIcon(React.createElement("path", { d: "m321-80-71-71 329-329-329-329 71-71 400 400L321-80Z" }), 'ArrowForwardIos', '0 -960 960 960');
...
var Article = createSvgIcon(React.createElement("path", { d: "M7 17H14V15H7V17ZM7 13H17V11H7V13ZM7 9H17V7H7V9ZM5 21C4.45 21 3.975 20.8083 3.575 20.425C3.19167 20.025 3 19.55 3 19V5C3 4.45 3.19167 3.98333 3.575 3.6C3.975 3.2 4.45 3 5 3H19C19.55 3 20.0167 3.2 20.4 3.6C20.8 3.98333 21 4.45 21 5V19C21 19.55 20.8 20.025 20.4 20.425C20.0167 20.8083 19.55 21 19 21H5ZM5 19H19V5H5V19ZM5 5V19V5Z" }), 'Article');
...
var Feedback = createSvgIcon(React.createElement("path", { d: "M491-339q70 0 119-45t49-109q0-57-36.5-96.5T534-629q-47 0-79.5 30T422-525q0 19 7.5 37t21.5 33l57-57q-3-2-4.5-5t-1.5-7q0-11 9-17.5t23-6.5q20 0 33 16.5t13 39.5q0 31-25.5 52.5T492-418q-47 0-79.5-38T380-549q0-29 11-55.5t31-46.5l-57-57q-32 31-49 72t-17 86q0 88 56 149.5T491-339ZM240-80v-172q-57-52-88.5-121.5T120-520q0-150 105-255t255-105q125 0 221.5 73.5T827-615l52 205q5 19-7 34.5T840-360h-80v120q0 33-23.5 56.5T680-160h-80v80h-80v-160h160v-200h108l-38-155q-23-91-98-148t-172-57q-116 0-198 81t-82 197q0 60 24.5 114t69.5 96l26 24v208h-80Zm254-360Z" }), 'Feedback', '0 -960 960 960');
...
var NextWeek = createSvgIcon(React.createElement("path", { d: "m440-260 160-160-160-160-56 56 104 104-104 104 56 56ZM160-120q-33 0-56.5-23.5T80-200v-440q0-33 23.5-56.5T160-720h160v-80q0-33 23.5-56.5T400-880h160q33 0 56.5 23.5T640-800v80h160q33 0 56.5 23.5T880-640v440q0 33-23.5 56.5T800-120H160Zm0-80h640v-440H160v440Zm240-520h160v-80H400v80ZM160-200v-440 440Z" }), 'NextWeek', '0 -960 960 960');
...
var Seating = createSvgIcon(React.createElement(React.Fragment, null,
...
export { AISearch, Add, AddTask, AddToWorkflow, Alarm, Analytics, ArrowBack, ArrowBackIos, ArrowDownward, ArrowForwardIos, ArrowRightAlt, ArrowUpward, Article, AssignmentIndicator, AudioDownload, BarChart, Block, Blur, BlurSlightly, Calendar, Call, CallEnd, Cancel, CancelOutline, CancelPresentation, Category, Chat, ChatBubbleOutline, ChatDownload, CheckCircleOutline, ChevronLeft, ChevronRight, Close, ClosedCaption, Columns, Compass, Contacts, Database, DateRange, DayView, Delete, Description, DesktopUIDownload, Domain, Done, Draw, Edit, _Error as Error, ErrorOutline, Event, EventBusy, EventNote, ExitToApp, ExpandLess, ExpandMore, Favorite, FavoriteOutline, Feedback, FileCopy, FileMissing, Files, FilterList, FilterListOff, FirstPage, Folder, FormatListBulleted, Fullscreen, Globe, GroupWork, HelpOutline, Home, HourglassEmpty, Image, Info, KeyboardArrowDown, KeyboardArrowUp, Language, LastPage, Launch, Link, LinkOff, ListAlt, Lock, LockOpen, Lunch, Mail, _Map as Map, Merge, Message, Mic, MicOff, MoreVert, NetworkCheck, NewReleases, NextWeek, NoPhotography, Notes, NotesDownload, OpenInBrowser, PanelClose, PanelOpen, People, Percent, Person, PersonAdd, PersonOff, PhoneLink, PhotoCamera, Place, Portrait, PresentToAll, PrivateNotes, QrCode, QuestionAnswer, RadioActive, RadioInactive, Redo, Refresh, RemoveCircle, Repeat, ReportProblem, Room, Rows, Save, SaveAlt, Schedule, Search, Seating, Send, Serve, Settings, SignDocument, Speaker, SplitscreenAdd, Star, StarHalf, StarOutline, Support, SupportAgent, SyncAlt, Target, TaskComplete, Timelapse, Tune, TurnRight, Undo, UnverifiedUser, VerifiedUser, VideoCam, VideoCamOff, Visibility, VisibilityOff, VolumeDown, VolumeMute, VolumeUp, Walk, Warning, Web, WebAsset, WeekView, Workflow, Workforce, ZoomIn, ZoomOut };
