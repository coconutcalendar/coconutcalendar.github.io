...
function Typography(_a) {
    ...
    return (React__default['default'].createElement(Component, { className: clsx__default['default']('font-sans', colors$1[color], truncate ? 'truncate' : null, variants$1[variant]), id: id }, children));
}
...
var useCheckbox = function () { return React.useContext(CheckboxContext); };
...
function Group$1(_a) {
    ...
    var _e = React.useState(), labelledBy = _e[0], setLabelledBy = _e[1];
    var contextValue = [
        {
            error: error,
            groupId: groupId,
    ...
    return (React__default['default'].createElement(CheckboxContext.Provider, { value: contextValue },
        React__default['default'].createElement("div", null,
            React__default['default'].createElement("div", __assign({}, (labelledBy
                ? { 'aria-labelledby': labelledBy }
                : ariaLabel
                    ? { 'aria-label': ariaLabel }
                    : {}), { className: clsx__default['default']("flex flex-".concat(direction), direction === 'row' ? 'items-center' : ''), role: "group" }), children),
            helperText ? (React__default['default'].createElement("span", { "aria-live": error ? 'assertive' : 'off', className: clsx__default['default']('text-xs', error ? 'text-error-main' : 'text-black-60'), id: "".concat(groupId, "-helper-text") }, helperText)) : null)));
}
...
function Input(_a) {
    ...
    return (React__default['default'].createElement("label", { className: clsx__default['default']('checkbox flex flex-col font-sans', disabled ? 'cursor-not-allowed' : 'cursor-pointer') },
        React__default['default'].createElement("div", { className: "flex items-center" },
            React__default['default'].createElement("span", { className: clsx__default['default']('shrink-0 rounded-full focus:outline-none relative transition-colors duration-150 ease-out', disabled ? colors$5[color].disabled : colors$5[color].default, focused ? colors$5[color].focused : null, constrained ? sizes$3.constrained[size] : sizes$3.default[size]) },
                React__default['default'].createElement("input", { "aria-describedby": describedBy, "aria-invalid": resolvedError, "aria-label": label, className: clsx__default['default']('absolute inset-0 w-full h-full p-0 m-0 opacity-0', disabled ? 'cursor-not-allowed' : 'cursor-pointer'), "data-key": key, defaultChecked: initialStatus === 'checked', disabled: disabled, name: name, onBlur: handleBlur, onChange: handleChange, onFocus: handleFocus, ref: checkboxRef, tabIndex: tabIndex, type: "checkbox", value: value }),
                React__default['default'].createElement("span", { className: clsx__default['default']('status-active absolute inset-0', constrained ? null : 'p-2', disabled ? colors$5[color].disabled : colors$5[color].color) },
                    React__default['default'].createElement(CheckBoxChecked, null)),
                React__default['default'].createElement("span", { className: clsx__default['default']('status-indeterminate absolute inset-0', constrained ? null : 'p-2', disabled ? colors$5[color].disabled : colors$5[color].color) },
                    React__default['default'].createElement(CheckBoxIndeterminate, null)),
                React__default['default'].createElement("span", { className: clsx__default['default']('status-inactive absolute inset-0', constrained ? null : 'p-2', disabled ? colors$5[color].disabled : colors$5[color].unchecked) },
...
function Label(_a) {
    ...
    React.useEffect(function () { return setLabelledBy(id); }, [id, setLabelledBy]);
    return (React__default['default'].createElement(Typography, { id: id, variant: "subtitle2" }, children));
}
...
function Item(_a, ref) {
    ...
    var _m = React.useState(undefined), submenuId = _m[0], setSubmenuId = _m[1];
    var _o = React.useReducer(function (state) {
        return !state;
    ...
    return (React__default['default'].createElement(SubmenuContext.Provider, { value: [{ id: id, ref: ref, show: showSubmenu }, runReducer] },
        React__default['default'].createElement("li", { className: autocomplete === null ? 'max-w-xs' : '', 
            ...
            role: "presentation" },
            React__default['default'].createElement("button", __assign({ "aria-checked": isCheckbox ? checked : undefined, "aria-label": label, "aria-labelledby": labelledBy, "aria-selected": state.listbox && selected ? 'true' : undefined, 
                ...
                React__default['default'].createElement("div", { className: clsx__default['default']('flex items-center w-full', inset ? 'pl-11' : null) },
                    ...
                    isCheckbox ? (React__default['default'].createElement("span", { className: "flex" },
                        ...
                        React__default['default'].createElement("span", { className: clsx__default['default']('flex items-center justify-between w-full', wrapText ? 'whitespace-normal break-words' : 'truncate') },
...
createSvgIcon(React__default['default'].createElement("path", { d: "M640-80 240-480l400-400 71 71-329 329 329 329-71 71Z" }), 'ArrowBackIos', '0 -960 960 960');
...
createSvgIcon(React__default['default'].createElement("path", { d: "m321-80-71-71 329-329-329-329 71-71 400 400L321-80Z" }), 'ArrowForwardIos', '0 -960 960 960');
            ...
            React__default['default'].createElement(ReactRemoveScroll, { enabled: !disabled },
                React__default['default'].createElement(FocusLockCombination, { disabled: disabled, returnFocus: true },
                    React__default['default'].createElement("div", { className: clsx__default['default']('relative flex flex-col overflow-auto font-sans rounded outline-none shadow-24 bg-white-100', constraints[constraint]) },
                        React__default['default'].createElement(DialogContext.Provider, { value: [state, dispatch, onDismiss] }, children))))))) : null;
}
function Header$1(_a) {
    ...
    return (React__default['default'].createElement("div", { className: clsx__default['default']('flex items-center justify-between', state.dismissable ? 'px-6 py-4' : 'p-6') },
        ...
        state.dismissable ? (React__default['default'].createElement("div", { className: "ml-2" },
            React__default['default'].createElement(IconButton, { "aria-label": intl.formatMessage({ id: 'Ui.close' }), onClick: onDismiss, size: "medium" },
                React__default['default'].createElement(Close, null)))) : null));
}
...
function Header$2(_a) {
    var children = _a.children;
    var modalContext = reactAriaComponents.useSlottedContext(reactAriaComponents.ModalContext);
    ...
    return (React__default['default'].createElement("div", { className: clsx__default['default']('flex items-center justify-between p-4 pl-6 shrink-0 sticky top-0 bg-white-100 z-9999 transition-shadow duration-200', hasScrolled && 'shadow-3'), ref: headerRef },
        React__default['default'].createElement(reactAriaComponents.Heading, { slot: "title" }, children),
        isDismissable ? (React__default['default'].createElement(IconButton, { "aria-label": intl.formatMessage({ id: 'Ui.close' }), onClick: function () { return onOpenChange === null || onOpenChange === void 0 ? void 0 : onOpenChange(false); }, size: "base" },
            React__default['default'].createElement(Close, null))) : null));
}

/* eslint-disable react/forbid-component-props */
function Drawer(_a) {
    var ariaLabel = _a.ariaLabel, ariaLabelledBy = _a.ariaLabelledBy, _b = _a.backdrop, backdrop = _b === void 0 ? exports.Backdrops.Dark : _b, _c = _a.backdropBlurred, backdropBlurred = _c === void 0 ? true : _c, children = _a.children, _d = _a.dismissable, dismissable = _d === void 0 ? true : _d, _e = _a.open, open = _e === void 0 ? false : _e, onOpenChange = _a.onOpenChange, panelOffset = _a.panelOffset, _f = _a.placement, placement = _f === void 0 ? 'right' : _f;
    var overlayStyles = clsx__default['default']('react-aria-drawer-overlay fixed inset-0 z-[9997]', backdrop === exports.Backdrops.Light ? 'bg-white-45' : 'bg-black-45', backdropBlurred && 'backdrop-blur-2');
    ...
    return (React__default['default'].createElement(reactAriaComponents.ModalContext.Provider, { value: { isDismissable: dismissable, onOpenChange: onOpenChange } },
        React__default['default'].createElement(reactAriaComponents.ModalOverlay, { className: overlayStyles, isKeyboardDismissDisabled: !dismissable, isOpen: open, 
            ...
            React__default['default'].createElement(reactAriaComponents.Modal, { className: drawerStyles, "data-placement": placement, style: panelStyle },
                React__default['default'].createElement(reactAriaComponents.Dialog, { "aria-label": ariaLabel, "aria-labelledby": ariaLabelledBy }, children)))));
}
...
function Popover(_a) {
    ...
    var _e = React.useState(false), isNearEdge = _e[0], setIsNearEdge = _e[1];
    var isCenterPlacement = placement === 'center';
    React.useEffect(function useCenterPlacementOffset() {
    ...
    React.useEffect(function useEdgeProximityDetection() {
        var trigger = triggerRef === null || triggerRef === void 0 ? void 0 : triggerRef.current;
    ...
    return (React__default['default'].createElement(reactAriaComponents.Popover, { "aria-describedby": ariaDescribedby, "aria-label": ariaLabel, "aria-labelledby": ariaLabelledby, className: clsx__default['default']('react-aria-Popover focus-visible:ring', isCenterPlacement && !isNearEdge && 'center-placement'), isOpen: isOpen, offset: offset, onOpenChange: onOpenChange, placement: isCenterPlacement ? 'top' : placement, ref: popoverRef, triggerRef: triggerRef }, children));
}
...
function Group$3(_a) {
    ...
    return (React__default['default'].createElement(RadioContext.Provider, { value: [state, setValue, setLabelledBy] },
        React__default['default'].createElement("div", { className: "flex flex-col" },
            React__default['default'].createElement("div", { "aria-invalid": error, "aria-labelledby": state.labelledBy, className: clsx__default['default']("flex flex-".concat(direction), direction === 'row' ? 'items-center' : ''), role: "radiogroup" }, children),
...
function Input$1(_a) {
    ...
    return (React__default['default'].createElement("label", { className: clsx__default['default']('radio font-sans inline-flex items-center group', disabled ? 'cursor-not-allowed' : 'cursor-pointer') },
        React__default['default'].createElement("span", { className: clsx__default['default']('rounded-full focus:outline-none relative', disabled ? null : colors$8[color].background.default, focused ? colors$8[color].background.focused : null, sizes$8[size]) },
            ...
            React__default['default'].createElement("span", { className: clsx__default['default']('status-active absolute inset-0 rounded-full p-2', disabled
                    ? colors$8[color].foreground.disabled
                    : colors$8[color].foreground.active) },
                React__default['default'].createElement(RadioActive, null)),
            React__default['default'].createElement("span", { className: clsx__default['default']('status-inactive absolute inset-0 rounded-full p-2', disabled
                    ? colors$8[color].foreground.disabled
...
function Option(_a, ref) {
    ...
    return (React__default['default'].createElement(Menu.Item, { disabled: disabled, onClick: handleClick, ref: optionRef, selected: selected, wrapText: wrapText }, children));
}
...
function Select(_a) {
    ...
    var localRef = React.useRef(null);
    var syncRef = useSyncRefs(localRef, inputRef);
    var _j = React.useReducer(runReducer$6, {}, function () { return ({
        value: defaultValue,
    ...
    return (React__default['default'].createElement(SelectContext.Provider, { value: [
...
function Body() {
    ...
    return (React__default['default'].createElement("tbody", null, state.loading ? (React__default['default'].createElement("tr", { className: "absolute inset-0 flex items-center justify-center mt-32" },
        ...
        return (React__default['default'].createElement("tr", { "aria-selected": state.selectable
            ...
            state.columns.selected.map(function (column) { return (React__default['default'].createElement(Cell, { key: column.key, selected: row === null || row === void 0 ? void 0 : row.selected }, row[column.key] ? (row[column.key]) : (React__default['default'].createElement("span", { className: "text-black-60" }, "\u2014")))); }),
            state.staticColumns && !hasRowActions ? null : (React__default['default'].createElement(Cell, { selected: row === null || row === void 0 ? void 0 : row.selected, sticky: true }, showRowAction ? (React__default['default'].createElement(Menu, { placement: "bottom-end" },
                rowActionLabelKey ? (React__default['default'].createElement("span", { className: "hidden", id: rowLabelId }, ", ".concat(row[rowActionLabelKey]))) : null,
                React__default['default'].createElement(Menu.Button, { "aria-labelledby": rowActionLabelKey
                        ? "".concat(moreButtonLabelId, " ").concat(rowLabelId)
                        : undefined, icon: true, label: intl.formatMessage({ id: 'Table.more_actions' }) },
                    React__default['default'].createElement("span", { className: "hidden", id: moreButtonLabelId }, intl.formatMessage({ id: 'Table.more_actions' })),
                ...
                React__default['default'].createElement(Menu.Items, null, (_c = (_b = state.rowActions) === null || _b === void 0 ? void 0 : _b.filter(function (action) {
                    ...
                    return (React__default['default'].createElement("div", { className: "text-black-60", key: "".concat(row.id, "-").concat(action.label) },
                        React__default['default'].createElement(Menu.Item, { "aria-labelledby": rowActionLabelKey
                                ? "".concat(actionLabelId, " ").concat(rowLabelId)
                                : undefined, onClick: onClick, startAdornment: action.startAdornment },
                            React__default['default'].createElement("div", { className: "text-black-90", id: actionLabelId }, action.label))));
                })))) : null))));
    }))));
}
...
function BulkActions(_a) {
    ...
    return (React__default['default'].createElement("div", { className: "flex items-center py-px" },
        React__default['default'].createElement(Typography, { component: "p", variant: "subtitle2" },
            React__default['default'].createElement(reactIntl.FormattedMessage, { id: "Ui.number_selected", values: { number: numberSelected } })),
        React__default['default'].createElement("div", { className: "ml-6 items-center flex space-x-3" },
            React__default['default'].createElement(Button, { onClick: function () {
                    handleChange(false);
                }, variant: "contained" },
                React__default['default'].createElement(reactIntl.FormattedMessage, { id: "Table.clear_selection" })),
            !state.allSelected ? (React__default['default'].createElement(Button, { onClick: function () {
                    handleChange(true);
                }, variant: "contained" },
                React__default['default'].createElement(reactIntl.FormattedMessage, { id: "Table.select_all_n", values: { count: state.rows.length } }))) : null,
...
function Table(_a) {
    ...
    return (React__default['default'].createElement(TableContext.Provider, { value: [state, dispatch] },
        React__default['default'].createElement(BaseTable, { columns: initialColumns, dense: dense, loading: loading, rowActions: rowActions, rows: rows, scrollable: scrollable, selectable: selectable, selectedIds: selectedIds, storageKey: storageKey, total: total }, children)));
}
...
function Tag(_a) {
    ...
    return (React__default['default'].createElement("span", { className: clsx__default['default']('rounded-sm inline-flex cursor-default', colors$b[color].root, sizes$b[size].root) },
        React__default['default'].createElement("span", { className: "flex items-center" },
            StartAdornment ? (React__default['default'].createElement("span", { className: clsx__default['default'](sizes$b[size].icon, colors$b[color].icon) },
                React__default['default'].createElement(StartAdornment, null))) : null,
            React__default['default'].createElement("span", { className: clsx__default['default']('w-full', sizes$b[size].text, colors$b[color].text) }, label))));
}
