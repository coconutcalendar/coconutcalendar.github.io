...
import AISearch from './icons/AISearch';
...
import NextWeek from './icons/NextWeek';
...
import SplitscreenAdd from './icons/SplitscreenAdd';
...
export { Add, AddTask, AddToWorkflow, AISearch, Alarm, Analytics, ArrowBack, ArrowBackIos, ArrowDownward, ArrowForwardIos, ArrowRightAlt, ArrowUpward, Article, AssignmentIndicator, AudioDownload, BarChart, Block, Blur, BlurSlightly, Calendar, Call, CallEnd, Cancel, CancelOutline, CancelPresentation, Category, Chat, ChatBubbleOutline, ChatDownload, CheckCircleOutline, ChevronLeft, ChevronRight, Close, ClosedCaption, Columns, Compass, Contacts, Database, DateRange, DayView, Delete, Description, DesktopUIDownload, Domain, Done, Draw, Edit, Error, ErrorOutline, Event, EventBusy, EventNote, ExitToApp, ExpandLess, ExpandMore, Favorite, Feedback, FavoriteOutline, FileCopy, FileMissing, Files, FilterList, FilterListOff, FirstPage, Folder, FormatListBulleted, Fullscreen, Globe, GroupWork, HelpOutline, Home, HourglassEmpty, Image, Info, KeyboardArrowDown, KeyboardArrowUp, Language, LastPage, Launch, Link, LinkOff, ListAlt, Lock, LockOpen, Lunch, Mail, Map, Merge, Message, Mic, MicOff, MoreVert, NetworkCheck, NewReleases, NextWeek, NoPhotography, Notes, NotesDownload, OpenInBrowser, PanelClose, PanelOpen, People, Percent, Person, PersonAdd, PersonOff, PhoneLink, PhotoCamera, Place, Seating, SplitscreenAdd, Portrait, PresentToAll, PrivateNotes, QrCode, QuestionAnswer, RadioActive, RadioInactive, Redo, Refresh, RemoveCircle, Repeat, ReportProblem, Room, Rows, Save, SaveAlt, Schedule, Search, Send, Serve, Settings, SignDocument, Speaker, Support, SupportAgent, SyncAlt, Star, StarHalf, StarOutline, TaskComplete, Target, Timelapse, Tune, TurnRight, Undo, UnverifiedUser, VerifiedUser, VideoCam, VideoCamOff, Visibility, VisibilityOff, VolumeDown, VolumeMute, VolumeUp, Walk, Warning, Web, WebAsset, WeekView, Workflow, Workforce, ZoomIn, ZoomOut, };
