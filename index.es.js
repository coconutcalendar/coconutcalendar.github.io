...
function Avatar(_a) {
    ...
    return (React.createElement("div", { "aria-label": label || name, className: clsx('justify-center items-center text-xl inline-flex w-10 h-10 p-2', colors$6[color], variants$4[variant]), role: "img" }, name !== undefined
